...
/*-----------------------------------------------------------------------------------------
  ...
  --------     ----         -------------------------------------    ----------------------
  2011-05-11   lijing       reduce preview noise                     ZTE_CAM_LJ_20110511
...
#else
    {0x62, 0x9a, BYTE_LEN ,0}, //SATB  (1.4x)
    {0x63, 0x9a, BYTE_LEN ,0}, //SATR  (1.2x)
#endif
...
#else
    {0x20, 0x04, BYTE_LEN ,0},	//SHARP_Negative   
...
#else
    {0x22, 0x28, BYTE_LEN ,0}, //0510//0x66, BYTE_LEN ,0}, //76, 34, 2b
    {0x23, 0x18, BYTE_LEN ,0}, //0510//0x50, BYTE_LEN ,0},
    {0x24, 0x18, BYTE_LEN ,0},
#endif
