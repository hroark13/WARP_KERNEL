...
#define MPU_I2C_READ 		_IOR(MPU_IOCTL, 0x13, struct mpu_read_write)
#define MPU_I2C_WRITE 		_IOW(MPU_IOCTL, 0x13, struct mpu_read_write)
...
/** ZTE_MODIFY zhaoyang modify gyroscope driver to support kxtik accelerometer zhaoy0030 2011/08/25*/
#if 0
...
///////////////
/** ZTE_MODIFY zhaoyang modify gyroscope driver to support kxtik accelerometer zhaoy0030 2011/08/25*/
#ifdef CONFIG_MPU_KXTF9_or_MPU_MMA845X_or_MPU_LIS3DH	/* ST accelerometer or Freescale accelerometer */
