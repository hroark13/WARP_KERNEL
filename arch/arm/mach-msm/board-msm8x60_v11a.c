...
static struct max17040_platform_data max17040_data  = {
	.ini_data = {
		...
		.fulladjustment = 100,
		.rcomp0 = 130,
		.tempcoup = 0,	/* should div 100, real is 0 */
		.tempcodown = -335,	/* should div 100, real is -3.35 */
		.ocvtest = 56096,
		.socchecka = 245,
		.soccheckb = 247,
		.bits = 19,
		.data = {
			0x1F, 0x67, 0xB2, 0xBB, 0xD1, 0xD7, 0xDA, 0xDC,
			0xDF, 0xEF, 0x0C, 0x14, 0x68, 0x90, 0xDE, 0x12,
			0xD0, 0x0D, 0xE1, 0x02, 0x07, 0x0C, 0x11, 0x0F,
			0x61, 0x01, 0x91, 0x08, 0xD1, 0x0D, 0x11, 0x0D,
			0xA1, 0xF0, 0xB6, 0x70, 0xBB, 0x20, 0xBB, 0xB0,
			0xBD, 0x10, 0xBD, 0x70, 0xBD, 0xA0, 0xBD, 0xC0,
			0xBD, 0xF0, 0xBE, 0xF0, 0xC0, 0xC0, 0xC1, 0x40,
			0xC6, 0x80, 0xC9, 0x00, 0xCD, 0xE0, 0xD1, 0x20,
			0x01, 0x70, 0x0E, 0xF0, 0x57, 0xD0, 0x21, 0xF0,
			0xBD, 0xF0, 0xDF, 0x00, 0xB7, 0x90, 0x7C, 0x20,
			0x0F, 0xD0, 0x10, 0x20, 0x78, 0xC0, 0x14, 0xF0,
			0x1F, 0x10, 0x12, 0x80, 0x12, 0xD0, 0x12, 0xD0,
			0x10, 0x07, 0x60, 0x0F, 0xB5, 0x0D, 0xB2, 0x0F,
			0xDB, 0x0F, 0xDD, 0x00, 0xDB, 0x09, 0xD7, 0x02,
			0x17, 0xEF, 0x7D, 0x1F, 0xDF, 0xF0, 0x79, 0xC2,
