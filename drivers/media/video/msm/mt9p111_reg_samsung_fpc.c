...
/*-----------------------------------------------------------------------------------------
  ...
  --------     ----         -------------------------------------    ----------------------
  2011-03-07   wt           change preview width height for zoom     ZTE_WT_CAME_20110307
...
static struct mt9p111_i2c_reg_conf const preview_snapshot_mode_reg_settings_array[] = {
    ...
    //ZTE_WT_CAME_20110307 change preview width height for zoom
    ...
    {0xAC40, 0x60,BYTE_LEN,0}, 	// AWB_MIN_ACCEPTED_POST_AWB_R2G_RATIO
    {0xAC41, 0x63,BYTE_LEN,0}, 	// AWB_MAX_ACCEPTED_POST_AWB_R2G_RATIO
...
static struct mt9p111_i2c_reg_conf const saturation_tbl_2[] = {
    {0xBC56, 0xBF, BYTE_LEN, 0}, // LL_START_CCM_SATURATION
    {0xBC57, 0x38, BYTE_LEN, 0}, // LL_END_CCM_SATURATION    
    {0x098E, 0xDC35, WORD_LEN, 0}, // LOGICAL_ADDRESS_ACCESS [SYS_UV_COLOR_BOOST]       
    {0xDC35, 0x04, BYTE_LEN, 0}, // SYS_UV_COLOR_BOOST                                 
    {0x8404, 0x06, BYTE_LEN, 10}, // SEQ_CMD 
};
