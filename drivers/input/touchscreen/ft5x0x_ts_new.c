...
#define GPIO_TOUCH_INT_WAKEUP	55	
...
struct Fts_ts_data
{
	...
	struct Fts_finger_data finger_data[5];//xym
	int touch_number;//xym
	int touch_event;//xym
	int use_irq;
	int gpio_irq;
...
static int Fts_i2c_read(struct i2c_client *client, uint8_t reg, uint8_t * buf, int count) 
{
	int ret;
	struct i2c_msg msg[] = {
		{
...
"0x01:139:60:850:100:80:0x01:102:180:850:100:80:0x01:158:300:850:100:80:0x01:217:420:850:100:80";
#else
static const char ts_keys_size[] =
"0x01:139:60:850:100:80:0x01:102:180:850:100:80:0x01:158:300:850:100:80:0x01:217:420:850:100:80";
#endif 
...
#include "Ver10_20110630_038_9633_bladeplus_app.i" 
#else
#endif
//#include "ft_app1.i"
};
